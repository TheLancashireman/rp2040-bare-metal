/* adc-test.cxx - testing the adc free-running mode
 *
 * (c) David Haworth
 *
 ...
 *
 * The value obtained from the internal temperature sensor is printed one per second.
 *
 * The code compiles with the C++ compiler
*/
