...
void rp2040_pll_init(void)
{
	...
	*/
	if ( (rp2040_pll.cs & RP2040_PLL_LOCK) != 0 &&
		 (rp2040_pll.cs & RP2040_PLL_REFDIV) == MY_REFDIV &&
		 (rp2040_pll.fbdiv_int & RP2040_PLL_FBDIV) == MY_FBDIV &&
		 (rp2040_pll.prim & (RP2040_PLL_POSTDIV1 | RP2040_PLL_POSTDIV2)) == MY_POSTDIVS )
		return;
	...
	*/
	pll_helper(&rp2040_pll, &rp2040_pll_w1c, MY_FBDIV, MY_POSTDIVS);
...
void rp2040_usbpll_init(void)
{
	...
	*/
	if ( (rp2040_usbpll.cs & RP2040_PLL_LOCK) != 0 &&
		 (rp2040_usbpll.cs & RP2040_PLL_REFDIV) == MY_REFDIV &&
		 (rp2040_usbpll.fbdiv_int & RP2040_PLL_FBDIV) == MY_USB_FBDIV &&
		 (rp2040_usbpll.prim & (RP2040_PLL_POSTDIV1 | RP2040_PLL_POSTDIV2)) == MY_USB_POSTDIVS )
		return;
	...
	*/
	pll_helper(&rp2040_usbpll, &rp2040_usbpll_w1c, MY_USB_FBDIV, MY_USB_POSTDIVS);
